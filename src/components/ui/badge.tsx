...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border-2 px-3 py-1 text-xs font-bold uppercase tracking-wide transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-sm",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground border-current hover:bg-foreground/10",
      },
    },
    defaultVariants: {
      variant: "default",
